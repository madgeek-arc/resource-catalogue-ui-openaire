...
// Classification Information //
  ...
  .set('targetUsersDesc', {mandatory: true,  label: 'Target Users', addTitle: 'Target UserInfo', placeholder: 'Select target users...', desc: 'Type of users that commissions a Provider to deliver a Resource.'})
...
// Management Information //
  ...
  .set('userManualDesc', {mandatory: false, label: 'UserInfo Manual', placeholder: 'user manual URL', desc: 'Link to the Resource user manual and documentation.'})
